#include <SFML/Graphics.hpp>//elseni is gay
#include<thread>
...
{
    //?
    float plcounter = 0, pl_upper_melee_ctr = 0, pl_lower_melee_ctr = 0;
...
void windowfunction()
{
    ...
    if (Keyboard::isKeyPressed(Keyboard::Q) && rifle.ammo > 0)
    {
        player.gun = RIFLE;
    }
